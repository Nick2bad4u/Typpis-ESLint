...
const pkg = {
    ...
    version: "0.1.0",
    description: "Production-ready ESLint flat config that bundles the full Typpis plugin stack for TypeScript, React, and Electron apps.",
    license: "MIT",
    ...
    scripts: {
        ...
        "lint:fix": "eslint --config lib/configs/recommended.js --fix \"tests/fixtures/**/*\"",
    ...
    peerDependenciesMeta: Object.fromEntries(Object.keys(pkgVersions).map((name) => [name, { optional: false }]))
};
